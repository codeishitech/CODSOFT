class Contact_book:
    def __init__(self):
        self.contacts = {}   #creating an empty dictionary to store name of the contacts as keys and their phone numbers as their values:
    def add_contact(self):  #function to add contacts
        name=input("Enter the name of the contact:")
        phonenumber=input("Enter the phone number of the contact:")
        self.contacts[name] = phonenumber
